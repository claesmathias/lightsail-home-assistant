...
```
aws lightsail create-instances --instance-names "ha-vm" --availability-zone eu-west-2a --blueprint-id amazon_linux_2 --bundle-id medium_2_0 --user-data file://user-data.txt
```
